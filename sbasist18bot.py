...
import time, random, sys, re, os, json, glob, subprocess, threading, string, codecs, ctypes, urllib, urllib2, urllib3


cl = LINETCR.LINE()
cl.login(token="EmGENkFPcSgRH4GdnF76.bOvOGCf2RHfeZhv4yDfvG.1SNv/EnOVgfjjDOZy2fHMGaqGlfyHwzNQ1mhLn1Pe7M=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmvGUu0ABPqk2UfaxTN2.H2Lv/Jr24/NidMTbffnO4G.bVOAG/1k+DFyhpQPioeAwS0UujiZt8DUdPWnY4Tffk=")
ki.loginResult()

ki2= LINETCR.LINE()
ki2.login(token="EmPoL4uxWSgrU52Dtomb.1YsQzRhTiLU/0wktv1FLgW.VdBVdjqBn59ZWISpY0Np77P2vpeMlCSE4pJLY85VOs=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="Em0G6PVDtEPRuxHVSAC8.bKxbyGM6feSgEY6806oLQa.u7TDpmdktkJuGqNMgbyIqdwMfrxlHY/MFc8/uPAipQ=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EmmQBX9zYKUqdpGjSH8d.gcrtpjX9ttG/3GuSnu91hq.SWey7VLxuxLfEKr14NKUi+S1XbVWDz+tBzmg3Aw9rE=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EmRfaDOLPgmO93kSEJ36.e3vYCVDoGlGQij7Acfw4LGYsRh+WuLZJtzTfDowNOy522MzYbISj+It3lwqr+xB28=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EmXmAtQcKb2mokIRYVq6.63cv+t/1sOT6CzLwKpG7DG.nKmZtRoZ1EFclGk/n6rUA0nctJSLUt/UJEPgCmMP2U=")
ki6.loginResult()

ki7 = LINETCR.LINE() #Bot 7
ki7.login(token="EmTqcY8uROZNyyGsmB8c.vmETL4tOzbN0lOFYQJNH7a.ZtwOHRe1P6jXgA0TJeR/06CD4Ud7GLwR/TVZHXa2pI=")
ki7.loginResult()

ki8 = LINETCR.LINE() #Bot 8
ki8.login(token="Em0jUodTA2aXLgH3Bgh6.9zkQQXcYKYEwrakH49bR5G.vX9nT7KKRcpUQla2Xh3Fuwv27aqA6V9/GAlf4ot+pI=")
ki8.loginResult()

ki9 = LINETCR.LINE() #Bot 9
ki9.login(token="EmVP20YT8K3CqgzF9QX7.sNhFhG+SIkXOhHlzHjnZfW.+aJG70SqrqUPbgeY6wBZiBes1g4FF+u9XAUlkOqdVg=")
ki9.loginResult()

ki10 = LINETCR.LINE() #Bot 9
ki10.login(token="EmTIWZ71UwlFAvc55Uve.fR/LLpkQ7uak8AzoRulkG.xS7awGgBWrZUKN0Ml4crxBlxECuOzpzCIMCefLO5W9w=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="EnBZzhJPPED9gfIHW96b.gXQRZh1wEqN5nVZzj5RssW.bEELbfU7Ay+yLuRlBVmKnQZF1MbDKAcuB4x5cnVsI4=")
ki11.loginResult()

ki12= LINETCR.LINE()
ki12.login(token="EnMGaJZ6jqrv1b2rF5wb.fVnu69TcJ8E86WUDjsiDMW.ouZ6hTcRQYdgPxL+eTwduP1rlgyD+7jolNnZHVZUJo=")
ki12.loginResult()

ki13 = LINETCR.LINE()
ki13.login(token="EntcbZ6hct3CM6xPPrSf.bdJc2CtPR2TSv5gphRuypW.DYedAJW/H4bRh6DRLdt/AApp4oxAdecwma93de1ZfQ=")
ki13.loginResult()

ki14 = LINETCR.LINE()
ki14.login(token="EnBakiqeSP5g2hNr1xh6.lW4U9ah5dzBuriFhLNTmG.0FOTAdWQ/N5zVm3ryNfpGwbKqinyFh5+Px7739bzItQ=")
ki14.loginResult()

ki15 = LINETCR.LINE()
ki15.login(token="EnsOqkFOghlCIPMCpoC9.hISJl0t4r6pkGlJjGMG1wq.p0CeGIQVJ7jpVyovMtfEybzI6k3L5mEyCHo5I3BR3Y=")
ki15.loginResult()

ki16 = LINETCR.LINE()
ki16.login(token="Enx9HW7IqWLnO67Pk6f7.Z3Zg6iyBUoKfegnlMppIbW.AbG7P0ZAl2/zGkcP9RYp2DIGTFzFOw2XatrZrEfcfs=")
ki16.loginResult()

ki17 = LINETCR.LINE() #Bot 17
ki17.login(token="EnWCsbd7Y0DnRkTTCyjb.PgnzRce05tAF+VfXo1F9QW.wvpsPmO3hM2VHxds0gBLFNeBW0+J0MsGP9CHjux/LQ=")
ki17.loginResult()

ki18 = LINETCR.LINE() #Bot 18
ki18.login(token="EnnSDJIJhDcEJhYxTxfa.eN9etnjnxZHlipRS8kIocG.kasihandeehluuu+6JWypF4a3egbW4=")
ki18.loginResult()
...
helpMessage ="""『⊰◉⊱ᎢᎬᎪᎷ ᏴᏞᎪᏟᏦ ❂Ғ ᏀᎪᎷᎬᎡ⊰◉⊱』
❂••••••••℘ґ∂ηк в❍тѕ••••••••❂
